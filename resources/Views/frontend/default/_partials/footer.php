<footer class="footer">
    <div class="footer-top">
        <div class="container">
            <p class="footer-baseline">ADN du Web, spécialisé dans l'E-commerce et le développement sur mesure</p>           

            <ul class="social-links">
                <li>
                    <a href="https://www.facebook.com/Agence.adnduweb" target="_blank" rel="noopener" title="facebook" class="facebook"><i class="fab fa-facebook-f"></i></a>
                </li>
                <li>
                    <a href="https://www.instagram.com/adnduweb/" target="_blank" rel="noopener" title="twitter" class="twitter"><i class="fab fa-instagram"></i></a>
                </li>
                <li>
                    <a href="https://www.linkedin.com/in/fabrice-loru-1579a528/" target="_blank" rel="noopener" title="linkedin" class="linkedin"><i class="fab fa-linkedin"></i></a>
                </li>
                <li>
            </ul>
            ...
            <div class="footer-address">
                ...
                <p style="margin-top: 13px;">
                    <span>
                        <a style="margin: 5px;" href="<?= site_url(); ?>">🇫🇷</a>
                    </span>
                </p>
            </div>
        </div>
...
<div id="kt_scrolltop" class="scrolltop" data-kt-scrolltop="true">
        <!--begin::Svg Icon | path: assets/media/icons/duotone/Navigation/Up-2.svg-->
