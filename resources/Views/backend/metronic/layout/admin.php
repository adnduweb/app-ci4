...
<head>
	<?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\_head') ?>
	<?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\stylesheets') ?>
...
<body <?= service('theme')->printHtmlAttributes('body'); ?> <?= service('theme')->printHtmlClasses('body'); ?>  <?= service('theme')->printCssVariables('body'); ?> >
	...
	<?php if (Config('Theme')->layout['loader']['display'] === true){ ?>
		<?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\_page-loader') ?>
	<?php } ?>


	<?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\_content') ?>
    ...
    <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\javascript') ?>
