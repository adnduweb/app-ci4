<?php if (Config('Theme')->layout['extras']['quick-actions']['dropdown']['style'] == 'light'){ ?>
...
<?php }else{ ?>
    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('<?= assetAdmin('/media/misc/bg-1.jpg'); ?>')">
...
<div class="row row-paddingless">
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
            <?= service('theme')->getSVG('media/svg/icons/Shopping/Euro.svg', 'svg-icon-3x svg-icon-success'); ?> 
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
            <?= service('theme')->getSVG('media/svg/icons/Communication/Mail-attachment.svg', 'svg-icon-3x svg-icon-success'); ?> 
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
            <?= service('theme')->getSVG('media/svg/icons/Shopping/Box2.svg', 'svg-icon-3x svg-icon-success'); ?> 
    ...
    <div class="col-6">
        <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
            <?= service('theme')->getSVG('media/svg/icons/Communication/Group.svg', 'svg-icon-3x svg-icon-success'); ?> 
