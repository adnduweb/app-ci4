        ...
        <?php }else{ ?>
            <div class="dropdown" id="kt_quick_search_toggle">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_search-dropdown') ?>
                </div>
            </div>
        <?php } ?>
    <?php } ?>
    ...
    <?php if (Config('Theme')->layout['extras']['notifications']['display']){ ?>
        ...
        <?php }else{ ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_notifications') ?>
                    </form>
                </div>
            </div>
        <?php } ?>
    ...
    <?php if (Config('Theme')->layout['extras']['quick-actions']['display']){ ?>
        ...
        <?php }else{ ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_quick-actions') ?>
                </div>
            </div>
        <?php } ?>
    <?php } ?>
    ...
    <?php if (Config('Theme')->layout['extras']['cart']['display']){ ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                <form>
                    <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_cart') ?>
                </form>
            </div>
        </div>
    <?php } ?>
    ...
    <?php if (Config('Theme')->layout['extras']['languages']['display']){ ?>
        <div class="dropdown">
            ...
            <div class="dropdown-menu p-0 m-0 dropdown-menu-anim-up dropdown-menu-sm dropdown-menu-right">
                <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_languages') ?>
            </div>
        </div>
    <?php } ?>
        ...
        <?php }else{ ?>
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg p-0">
                    <?= $this->include('\Themes\backend\/'.$theme_admin.'/\layout\partials\extras\dropdown\_user') ?>
                </div>
            </div>
        <?php } ?>
    <?php } ?>
