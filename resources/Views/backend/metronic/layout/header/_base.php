		...
		<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1">
			...
			<?php  if (Config('Theme')->layout['header']['left'] == 'menu'){ ?>
				<div class="d-flex align-items-stretch" id="kt_header_nav">
					<?=  $this->include('\Themes\backend\/'.$theme_admin.'/\layout\header\_menu'); ?>
				</div>
			<?php }elseif(Config('Theme')->layout['header']['left']=== 'page-title'){ ?>
				<div class="d-flex align-items-center" id="kt_header_nav">
					<?=  $this->include('\Themes\backend\/'.$theme_admin.'/\layout\page-title\_' . Config('Theme')->layout['page-title']['layout']); ?>
				</div>
			<?php } ?>
			<!--end::Navbar-->
	        ...
	        <div class="d-flex align-items-stretch flex-shrink-0">
				<?=  $this->include('\Themes\backend\/'.$theme_admin.'/\layout\topbar\_base'); ?>
			</div>
			<!--end::Topbar-->
		</div>
		<!--end::Wrapper-->
