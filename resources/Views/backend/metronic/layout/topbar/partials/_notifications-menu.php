...
<div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
	<!--begin::Heading-->
    <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('<?= assetAdmin('/media/misc/pattern-1.jpg'); ?>')">
        <!--begin::Title-->
    ...
    <div class="tab-content">
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <div class="symbol symbol-35px me-4">
                                <span class="symbol-label bg-light-{{ $alert['state'] }}">
                                    <?= service('theme')->getSVG($alert['icon'], "svg-icon-2 svg-icon-" . $alert['state']); ?>
                                </span>
                            </div>
                            <!--end::Symbol-->
        ...
        <div class="tab-pane fade show active" id="kt_topbar_notifications_2" role="tabpanel">
            ...
            <div class="d-flex flex-column px-9">
                ...
                <!--begin::Illustration-->
                <img class="mh-200px" alt="metronic" src="<?= assetAdmin('/media/illustrations/work.png'); ?>"/>
                <!--end::Illustration-->
            </div>
            <!--end::Wrapper-->
        </div>
