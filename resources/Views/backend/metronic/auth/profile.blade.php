...
@foreach ($sessions as $session)
    <p>{{ $session->agent->platform }} : {{ $session->agent->browser }}  : {{ $session->ip_address }} </p>
    @if (($session->is_current_device) == 1)
        this device
    @endif
													...
													<div class="row">
														...
														<div class="col-xl-7 my-2">
																...
																<div class="col-9">
																	<div class="image-input image-input-empty image-input-outline" id="kt_user_edit_avatar" style="background-image: url(/metronic/theme/html/demo1/dist/assets/media/users/blank.png)">
																		...
																		<label class="btn btn-xs btn-icon btn-circle btn-white btn-hover-text-primary btn-shadow" data-action="change" data-toggle="tooltip" title="" data-original-title="Change avatar">
																			...
																			<input type="file" name="profile_avatar" accept=".png, .jpg, .jpeg" kl_vkbd_parsed="true">
																			<input type="hidden" name="profile_avatar_remove" kl_vkbd_parsed="true">
																		</label>
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" value="Anna" kl_vkbd_parsed="true">
																</div>
															</div>
															<!--end::Group-->
															<!--begin::Group-->
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" value="Krox" kl_vkbd_parsed="true">
																</div>
															</div>
															<!--end::Group-->
															<!--begin::Group-->
															<div class="form-group row">
																...
																<div class="col-9">
																	<input class="form-control form-control-lg form-control-solid" type="text" value="Loop Inc." kl_vkbd_parsed="true">
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<div class="input-group input-group-lg input-group-solid">
																		...
																		<input type="text" class="form-control form-control-lg form-control-solid" value="+45678967456" placeholder="Phone" kl_vkbd_parsed="true">
																	</div>
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<div class="input-group input-group-lg input-group-solid">
																		...
																		<input type="text" class="form-control form-control-lg form-control-solid" value="anna.krox@loop.com" placeholder="Email" kl_vkbd_parsed="true">
																	</div>
																</div>
															</div>
															<!--end::Group-->
															...
															<div class="form-group row">
																...
																<div class="col-9">
																	<div class="input-group input-group-lg input-group-solid">
																		<input type="text" class="form-control form-control-lg form-control-solid" placeholder="Username" value="loop" kl_vkbd_parsed="true">
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<div class="spinner spinner-sm spinner-success spinner-right spinner-input">
																			<input class="form-control form-control-lg form-control-solid" type="text" value="nick84" kl_vkbd_parsed="true">
																		</div>
																	</div>
																</div>
																<!--end::Group-->
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<div class="input-group input-group-lg input-group-solid">
																			...
																			<input type="text" class="form-control form-control-lg form-control-solid" value="nick.watson@loop.com" placeholder="Email" kl_vkbd_parsed="true">
																		</div>
																...
																<div class="form-group row align-items-center">
																	...
																	<div class="col-9">
																		<div class="checkbox-inline">
																			...
																			<input type="checkbox" checked="checked" kl_vkbd_parsed="true">
																			<span></span>Email</label>
																			<label class="checkbox">
																			<input type="checkbox" checked="checked" kl_vkbd_parsed="true">
																			<span></span>SMS</label>
																			<label class="checkbox">
																			<input type="checkbox" kl_vkbd_parsed="true">
														...
														<div class="row">
															...
															<div class="col-xl-7">
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<input class="form-control form-control-lg form-control-solid mb-1" type="text" value="Current password" kl_vkbd_parsed="true">
																...
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<input class="form-control form-control-lg form-control-solid" type="text" value="New password" kl_vkbd_parsed="true">
																	</div>
																</div>
																<!--end::Group-->
																<!--begin::Group-->
																<div class="form-group row">
																	...
																	<div class="col-9">
																		<input class="form-control form-control-lg form-control-solid" type="text" value="Verify password" kl_vkbd_parsed="true">
																	</div>
																</div>
																<!--end::Group-->
															</div>
															...
															<div class="my-2">
																...
																<div class="form-group row mb-2">
																	...
																	<div class="col-3">
																		<span class="switch">
																			<label>
																				<input type="checkbox" checked="checked" name="select" kl_vkbd_parsed="true">
																				<span></span>
																			</label>
																		</span>
																	</div>
																...
																<div class="form-group row">
																	...
																	<div class="col-3">
																		<span class="switch">
																			<label>
																				<input type="checkbox" name="select" kl_vkbd_parsed="true">
																				<span></span>
																			</label>
																		</span>
																	</div>
