...
<div class="card <?= $class; ?>">
    ...
    <div class="card-body py-3">
        <div class="tab-content">
            <?php foreach($tableRows as $tableRows){ ?>
                <?php
                    $loopIndex++;
                                    ...
                                    <tr>
                                        <td>
                                            <div class="symbol symbol-45px me-2">
                                                <span class="symbol-label">
                                                    <img src="<?= service('theme')->getMediaUrlPath() .  $row['image']; ?>" class="h-50 align-self-center" alt=""/>
                                                </span>
                                            </div>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <a href="#" class="btn btn-sm btn-icon btn-bg-light btn-active-color-primary">
                                                 <?= service('theme')->getSVG("icons/duotone/Navigation/Arrow-right.svg", "svg-icon-2"); ?>
                                            </a>
                                        </td>
                                    </tr>
                                <?php } ?>
