    ...
    <div class="card-header border-0 pt-5">
        ...
        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover" title="Click to add a user">
            <a href="#" class="btn btn-sm btn-light-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_invite_friends">
                <?= service('theme')->getSVG("icons/duotone/Communication/Add-user.svg", "svg-icon-3"); ?>
                New Member
            </a>
        </div>
    </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center">
                                    <div class="symbol symbol-45px me-5">
                                        <img src="<?= service('theme')->getMediaUrlPath() .  $row['user']['image']; ?>" alt=""/>
                                    </div>
                            ...
                            <td class="text-end">
                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <?= service('theme')->getSVG("icons/duotone/General/Settings-1.svg", "svg-icon-3"); ?>
                                </a>

                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                    <?= service('theme')->getSVG("icons/duotone/Communication/Write.svg", "svg-icon-3"); ?>
                                </a>

                                <a href="#" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                    <?= service('theme')->getSVG("icons/duotone/General/Trash.svg", "svg-icon-3"); ?>
                                </a>
                            </td>
                        </tr>
                    <?php } ?>
