...
<div class="card <?= $class; ?>">
    ...
    <div class="card-body d-flex flex-column">
        <!--begin::Chart-->
        <div class="mixed-widget-5-chart card-rounded-top" data-kt-chart-color="<?= $chartCcolor; ?>" data-kt-chart-url="<?= route_to('list-profit-ajax'); ?>" style="height: <?= $chartHeight; ?>"></div>
        <!--end::Chart-->
        ...
        <div class="mt-5">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="<?= assetAdmin('media/svg/brand-logos/plurk.svg'); ?>" alt="" class="h-50"/>
                        </div>
                    </div>
                    <!--end::Symbol-->
            ...
            <div class="d-flex flex-stack mb-5">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="<?= assetAdmin('media/svg/brand-logos/figma-1.svg'); ?>" alt="" class="h-50"/>
                        </div>
                    </div>
                    <!--end::Symbol-->
            ...
            <div class="d-flex flex-stack">
                ...
                <div class="d-flex align-items-center me-2">
                    ...
                    <div class="symbol symbol-50px me-3">
                        <div class="symbol-label bg-light">
                            <img src="<?= assetAdmin('media/svg/brand-logos/vimeo.svg'); ?>" alt="" class="h-50"/>
                        </div>
                    </div>
                    <!--end::Symbol-->
