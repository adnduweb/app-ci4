...
<div class="card <?= $class; ?>">
    ...
    <div class="card-body p-0">
        <!--begin::Chart-->
        <div class="mixed-widget-2-chart card-rounded-bottom bg-<?= $chartCcolor; ?>" data-kt-color="<?= $chartCcolor; ?>" data-kt-chart-url="<?= route_to('list-profit-ajax'); ?>" style="height: <?= $chartHeight; ?>"></div>
        <!--end::Chart-->
        ...
        <div class="card-p mt-n20 position-relative">
            ...
            <div class="row g-0">
                ...
                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                    <?= service('theme')->getSVG("icons/duotone/Media/Equalizer.svg", "svg-icon-3x svg-icon-warning d-block my-2"); ?>
                ...
                <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                    <?= service('theme')->getSVG("icons/duotone/Communication/Add-user.svg", "svg-icon-3x svg-icon-primary d-block my-2"); ?>
            ...
            <div class="row g-0">
                ...
                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                    <?= service('theme')->getSVG("icons/duotone/Design/Layers.svg", "svg-icon-3x svg-icon-danger d-block my-2"); ?>
                ...
                <div class="col bg-light-success px-6 py-8 rounded-2">
                              <?= service('theme')->getSVG("icons/duotone/Communication/Urgent-mail.svg", "svg-icon-3x svg-icon-danger d-block my-2"); ?>
