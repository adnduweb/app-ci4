                ...
                <div class="rounded ">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="kt_tab_pane_1" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\general') ?>
                        </div>
                        <div class="tab-pane fade" id="kt_tab_pane_2" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\security') ?>
                        </div>
                        <?php if(class_exists('\Adnduweb\Ci4Web\Web')){ ?>
                            <div class="tab-pane fade" id="kt_tab_pane_1" role="tabpanel">
                                <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\front') ?>
                            </div>
                        <?php } ?>
                        <div class="tab-pane fade" id="kt_tab_pane_4" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\analitycs_rgpd') ?>
                        </div>
                        <div class="tab-pane fade" id="kt_tab_pane_5" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\email') ?>
                        </div>
                        <div class="tab-pane fade" id="kt_tab_pane_6" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\language') ?>
                        </div>
                        <div class="tab-pane fade" id="kt_tab_pane_7" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\images') ?>
                        </div>
                        <?php if(class_exists('\Adnduweb\Ci4Ecommerce\Shopping')){ ?>
                            <div class="tab-pane fade" id="kt_tab_pane_8" role="tabpanel">
                                <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\ecommerce') ?>
                            </div>
                        <?php } ?>
                        <div class="tab-pane fade" id="kt_tab_pane_9" role="tabpanel">
                            <?= $this->include('Themes\backend\metronic\pages\settings\__form_section\command') ?>
                        </div>
