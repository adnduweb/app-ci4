...
class Validate
{
    ...
    public static function isEmail($email)
    {
        ...
        return !empty($email) && (new EmailValidator())->isValid($email, new MultipleValidationWithAnd([
                new RFCValidation(),
                new Email(), // special validation to be compatible with Swift Mailer
            ]));
    }
    ...
    public static function isCodeigniterVersion($version)
    {
