...
class Menu {
        ...
        if(isset($item['ancre'])){
            ...
            if(isset($item['sub']['items']) && is_array($item['sub']['items'])){
                foreach($item['sub']['items'] as $it){
                    if(in_array($it['ancre'], service('uri')->getSegments())){
                        $show_hover = true;
                    }
                }
                if($show_hover == true){
                ...
                if(in_array($item['ancre'], service('uri')->getSegments())){
                    $classes[]= 'show hover';
                }
            }
        }
    ...
    private function _generateItemLink($item) {
        ...
        if ( isset($item['path']) ) {
            // Assign the page URL
            $attributes['href'] = site_url(CI_AREA_ADMIN . '/' . $item['path']);
    ...
    private function _generateItemLinkTitle($item) {
        ...
        if ( isset($item['classes']) && isset($item['classes']['title']) ) {
            $classes[] = site_url(CI_AREA_ADMIN . '/' .  $item['classes']['title']);
        }
