<?= form_open('', ['id' => 'kt_apps_form', 'class' => 'kt-form', 'novalidate' => false]); ?>
    ...
    <input type="hidden" name="id_media_lang" value="<?= $form->id_media_lang; ?>" />
    ...
    <?php } ?>
        ...
        <div class="fv-row mb-7">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" class="form-control form-control-solid" required placeholder="" name="lang[<?= service('request')->getLocale(); ?>][titre]" type="text" value="<?= old('titre') ? old('titre') : $form->titre; ?>" kl_vkbd_parsed="true">
            <!--end::Input-->
        ...
        <div class="fv-row mb-7">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" class="form-control form-control-solid" placeholder="" value="<?= old('description') ? old('description') : $form->description; ?>" name="lang[<?= service('request')->getLocale(); ?>][description]" kl_vkbd_parsed="true">
            <!--end::Input-->
            <div class="invalid-feedback"><?= lang('Core.this_field_is_requis'); ?> </div>
        </div>
        <!--end::Input group-->
         ...
         <div class="fv-row mb-15">
            ...
            <!--end::Label-->
            <!--begin::Input-->
            <input type="text" class="form-control form-control-solid" placeholder="" value="<?= old('legende') ? old('legende') : $form->legende; ?>" name="lang[<?= service('request')->getLocale(); ?>][legende]" kl_vkbd_parsed="true">
            <!--end::Input-->
            <div class="invalid-feedback"><?= lang('Core.this_field_is_requis'); ?> </div>
        </div>
        <!--end::Input group-->
