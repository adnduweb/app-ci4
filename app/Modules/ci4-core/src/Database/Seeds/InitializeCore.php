    ...
    public function createUsers($uuid_company)
    {
        ...
        $setting = [
            ...
            [
                ...
                'datatype'  => 'string',
                'scope'     => 'global',
                'content'   => 'La meilleur application au monde',
                'protected' => 1,
                'summary'   => '',
            ],
            [
            ...
            [
                ...
                'datatype'  => 'string',
                'scope'     => 'global',
                'content'   => "C'est une application basée sur codegniter 4",
                'protected' => '1',
                'summary'   => '',
            ],
            [
    ...
    public function createModules()
    {
        ...
        $rowsType = [
            [
                ...
                'name'         => 'ci4 core',
                'handle'       => 'ci4-core',
                'path'         => ROOTPATH . 'app/Modules/ci4-core',
                'is_natif'     => 1,
                'is_installed' => 1,
                'active'       => 1,
                'created_at'   => date('Y-m-d H:i:s'),
            ...
            [
                ...
                'name'         => 'ci4 admin',
                'handle'       => 'ci4-admin',
                'path'         => ROOTPATH . 'app/Modules/ci4-admin',
                'is_natif'     => 1,
                'is_installed' => 1,
                'active'       => 1,
                'created_at'   => date('Y-m-d H:i:s'),
