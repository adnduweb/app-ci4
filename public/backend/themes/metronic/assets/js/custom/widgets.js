...
/***/ "./resources/backend/extended/js/custom/widgets.js":
/*!*********************************************************!*\
  !*** ./resources/backend/extended/js/custom/widgets.js ***!
  \*********************************************************/
...
var _require = __webpack_require__(/*! es6-shim/es6-shim.min */ "./node_modules/es6-shim/es6-shim.min.js"),
    console = _require.console; // Class definition
...
var KTWidgets = function () {
  ...
  var initMixedWidget2 = function initMixedWidget2() {
    ...
    [].slice.call(charts).map(function (element) {
      ...
      getData(element.getAttribute('data-kt-chart-url'), function (response) {
        ...
        options['xaxis']['categories'] = Object.keys(response.data); // render chart
  ...
  var initAsideToggle = function initAsideToggle() {
    var aside = document.querySelector('#kt_aside_toggle');

    if (aside) {
      aside.addEventListener('click', function (e) {
        e.preventDefault();
        axios.get(this.getAttribute('data-kt-url'), _defineProperty({}, crsftoken, $('meta[name="X-CSRF-TOKEN"]').attr('content'))).then(function (response) {
  ...
  return {
    init: function init() {
      ...
      initDarkModeToggle(); // Aside Toogle

      initAsideToggle(); // Statistics widgets
...
/******/ 	var __webpack_exports__ = __webpack_require__("./resources/backend/extended/js/custom/widgets.js");
/******/ 	
/******/ })()
;