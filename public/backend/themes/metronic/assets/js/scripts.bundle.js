...
var KTImageManager = function () {
  ...
  var id = [];
  var url = [];
  var bouttonCancelImageManager = document.querySelector('[data-kt-imagemanager-input-action="remove"]');
  ...
  var initRepeaterCreate = function initRepeaterCreate() {
  ...
  var initImageManager = function initImageManager() {
    document.querySelector('#kt_modal_image_manager').addEventListener('hide.bs.modal', function () {
      ...
      bouttonImageManager.forEach(function (d) {
  ...
  var handleInserer = function handleInserer() {
  ...
  var initImageManageReset = function initImageManageReset() {
