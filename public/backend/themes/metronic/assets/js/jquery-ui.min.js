...
(function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t(jQuery) })(function(t) {
    ...
    t.effects = { effect: {} },
        ...
        function() {
            ...
            t.expr && t.expr.filters && t.expr.filters.animated && (t.expr.filters.animated = function(e) { return function(i) { return !!t(i).data(a) || e(i) } }(t.expr.filters.animated)), t.uiBackCompat !== !1 && t.extend(t.effects, {
                save: function(t, e) { for (var i = 0, s = e.length; s > i; i++) null !== e[i] && t.data(n + e[i], t[0].style[e[i]]) },
                ...
                effect: function() {
                    function i(e) {
                        ...
                        function r() { t.isFunction(l) && l.call(h[0]), t.isFunction(e) && e() }
                        var h = t(this);
                    ...
                    return t.fx.off || !n ? c ? this[c](s.duration, l) : this.each(function() { l && l.call(this) }) : r === !1 ? this.each(d).each(i) : this.queue(h, d).queue(h, i)
                },
    ...
    t.effects.define("blind", "hide", function(e, i) {
        ...
        var s, n, o, a = t(this),
            ...
            _ = 0,
            b = a.queue().length;
        for (t.effects.createPlaceholder(a), o = a.css(m), u || (u = a["top" === m ? "outerHeight" : "outerWidth"]() / 3), l && (n = { opacity: 1 }, n[m] = o, a.css("opacity", 0).css(m, v ? 2 * -u : 2 * u).animate(n, f, g)), h && (u /= Math.pow(2, d - 1)), n = {}, n[m] = o; d > _; _++) s = {}, s[m] = (v ? "-=" : "+=") + u, a.animate(s, f, g).animate(n, f, g), u = h ? 2 * u : u / 2;
        h && (s = { opacity: 0 }, s[m] = (v ? "-=" : "+=") + u, a.animate(s, f, g)), a.queue(i), t.effects.unshift(a, b, p + 1)
