...
/*!*******************************************************************************************!*\
  !*** ./resources/backend/core/plugins/custom/tinymce/plugins/searchreplace/plugin.min.js ***!
  \*******************************************************************************************/
...
!function () {
  ...
  function B(e, t) {
    var n, r;
    n = e, r = t, T.from(n.dom.parentNode).map(se.fromDom).each(function (e) {
  ...
  function H(e, t, n, r, o) {
    var i, a, c, u, l, s;
    I(i = e, a = n) || P(i, a) || R(i, a) || "true" === (c = i).getContentEditable(u = a) && "false" === c.getContentEditableParent(u.parentNode) || (l = e.getParent(r, e.isBlock), s = new de(n, l), V(e, (o ? s.next : s.prev).bind(s), n, {
      boundary: f,
      cef: f,
  ...
  function L(e, t, n, r, o, i) {
    ...
    return H(e, u, n, t, !1), V(e, a.next.bind(a), n, {
      boundary: l,
      cef: function cef(e) {
  ...
  function U(u, e) {
    var n = j(e.startContainer, e.startOffset),
        ...
        i = o.element.dom;
    return L(u, e.commonAncestorContainer, r, i, {
  ...
  function K(e, t, n, r) {
    ...
    var i,
        ...
        h,
        g = e.getBody();
    return me(e, t, !1), r ? (c = e.dom, u = n, l = e.selection, s = o, d = l.getBookmark(), m = c.select("td[data-mce-selected],th[data-mce-selected]"), q(h = z(u, 0 < m.length ? (f = c, w(m, function (e) {
      return _(f, e);
    })) : $(c, l.getRng())), s), l.moveToBookmark(d), h.length) : (i = o, q(a = z(n, _(e.dom, g)), i), a.length);
  }
  ...
  function oe(i, a) {
    ...
    function f(e) {
      var t,
          ...
          r = e.getData(),
          o = a.get();
      r.findtext.length ? (o.text === r.findtext && o.matchCase === r.matchcase && o.wholeWord === r.wholewords ? ee(i, a) : ((t = Z(i, a, r.findtext, r.matchcase, r.wholewords, r.inselection)) <= 0 && (n = e, i.windowManager.alert("Could not find the specified string.", function () {
        n.focus("findtext");
      })), u(e, 0 === t)), c(e)) : s(e);
    }

    i.undoManager.add();
    var d = N.trim(i.selection.getContent({
      format: "text"
    })),
        m = a.get(),
        h = {
  ...
  o.add("searchreplace", function (e) {
    ...
    return (t = e).addCommand("SearchReplace", function () {
      ...
      onAction: ie(n, r),
      icon: "search"
    }), n.shortcuts.add("Meta+F", "", ie(n, r)), o = e, i = a, {
