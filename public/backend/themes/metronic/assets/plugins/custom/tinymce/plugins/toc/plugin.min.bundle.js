...
/*!*********************************************************************************!*\
  !*** ./resources/backend/core/plugins/custom/tinymce/plugins/toc/plugin.min.js ***!
  \*********************************************************************************/
/**
...
!function () {
  ...
  function d(t) {
    ...
    for (var l = 0; l < i.length; l++) {
      ...
      if (c === a.level) r += "<li>";else for (var d = c; d < a.level; d++) {
        r += "<ul><li>";
      }
      if (r += '<a href="#' + a.id + '">' + a.title + "</a>", u !== a.level && u) for (d = a.level; u < d; d--) {
        r += "</li></ul><li>";
      } else r += "</li>", u || (r += "</ul>");
      c = a.level;
    }
